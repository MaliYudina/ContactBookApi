...
class Author(models.Model):
    ...
    id_db_author = models.AutoField(verbose_name="Индекс ДБ", primary_key=True, db_index=True)
...
class Article(models.Model):
    ...
    id_db_article = models.AutoField(primary_key=True, db_index=True, verbose_name="Индекс ДБ")
